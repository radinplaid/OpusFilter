...
setuptools.setup(
    ...
    install_requires=["opustools", "beautifulsoup4", "graphviz", "langid", "matplotlib", "fast-mosestokenizer", "pandas>=0.24.0", "pycld2", "pyhash", "ruamel.yaml>=0.15.0", "regex", "scikit-learn", "tqdm"],
    classifiers=(
